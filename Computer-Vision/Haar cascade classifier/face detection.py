...
face_classifier = cv2.CascadeClassifier(r"C:\Users\LIKHITH\OneDrive\Desktop\Data science\opencv\haarcascade_frontalface_default.xml")# Load the image
image = cv2.imread(r"C:\Users\LIKHITH\OneDrive\Pictures\child.jpg")
